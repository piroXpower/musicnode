...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("MahakMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("MahakMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("MahakMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("MahakMusic/assets/play_icons.png")
